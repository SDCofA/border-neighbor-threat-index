...
METHODOLOGY_EVIDENCE = ["methodology.tex"]
...
def test_repository_hygiene_documentation_contract():
    ...
    assert "BNTI — multilingual, rules-based geopolitical threat index for Türkiye's seven border neighbors, with model classification required for numerical publication. Checked daily by GitHub Actions and published to GitHub Pages." in CONTRACT
